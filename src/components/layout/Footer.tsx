              ...
              <div className="space-y-4">
                <div ref={emailRef} className="footer-animation-item flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:guilherme@schiavon.dev?subject=Contact from Portfolio" 
                ...
                <div ref={phoneRef} className="footer-animation-item flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/5514996427690?text=Hello! I found your portfolio and would like to get in touch."
                      target="_blank"
