            ...
            <div>
              ...
              <div className="space-y-4">
                <a 
                  ...
                  target="_blank"
                  className="flex items-center space-x-3 text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-all duration-300 group"
                >
                  <div className="w-10 h-10 bg-neutral-200 dark:bg-neutral-800 group-hover:bg-primary-600 rounded-lg flex items-center justify-center transition-colors duration-300">
                ...
                <a 
                  href="https://www.instagram.com/guilherme__schiavon/" 
                  target="_blank"
                  className="flex items-center space-x-3 text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-all duration-300 group"
                >
